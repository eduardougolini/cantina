...
class Person extends \App\Entities\Person implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entities\\Person' . "\0" . 'id', '' . "\0" . 'App\\Entities\\Person' . "\0" . 'name', '' . "\0" . 'App\\Entities\\Person' . "\0" . 'birth', '' . "\0" . 'App\\Entities\\Person' . "\0" . 'email', '' . "\0" . 'App\\Entities\\Person' . "\0" . 'phone', '' . "\0" . 'App\\Entities\\Person' . "\0" . 'cpf', '' . "\0" . 'App\\Entities\\Person' . "\0" . 'rg', '' . "\0" . 'App\\Entities\\Person' . "\0" . 'responsible'];
        }
